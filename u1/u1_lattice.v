(* =========================================================================
   u1_lattice.v - Finite Volume Lattice Structure for U(1)

   Tier 0 minimal stack: finite list of links, explicit enumeration.
   No infinite lattice, no measure theory - just combinatorics.
...
(* =========================================================================
   Part 4: Configuration Type
   ========================================================================= *)

(* Configuration: assign angle to each link *)
Definition cfg := link -> R.

(* Agreement on a set of links *)
Definition agrees_on (ls : list link) (U V : cfg) : Prop :=
  forall l, In l ls -> U l = V l.
...
(* =========================================================================
   ...
   For action reflection symmetry, we need to reflect plaquettes.
   Key insight: because reflect_link uses "shift then reflect" for time-like
   links, we must use the same convention for plaquettes.
   ========================================================================= *)
...
(* For time-involving plaquettes: shift then reflect (to match reflect_link)
   For purely spatial plaquettes: just reflect site *)
...
(* NOTE:
   For time-like plaquettes, reflection changes orientation conventions.
   Boundary transport is handled at theta-level in u1_reflection.v
   (with sign-aware reflected edges), not as a raw boundary list equality here. *)
...
(* =========================================================================
   ...
   Plaquettes are classified by their base site's time coordinate.
   ========================================================================= *)
...
(* Plaquette is entirely in negative time.
   For time-like plaquettes, t=-1 touches the reflection plane and is treated
   as boundary, so strict negativity is t < -1.
   For purely spatial plaquettes, we also exclude the lower finite-volume
   boundary t = -L so reflection remains inside all_plaquettes L. *)
...
(* =========================================================================
   ...
   For action_reflection_symmetry, we need:
   1. reflect_plaq is an involution
   2. reflect_plaq preserves lattice membership
   3. reflect_plaq swaps positive/negative time halves
   ========================================================================= *)
